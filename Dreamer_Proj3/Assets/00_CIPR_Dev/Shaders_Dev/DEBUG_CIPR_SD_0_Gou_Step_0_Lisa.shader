Shader "CIPR/DEBUG_CIPR_0_Gou_step_0" {
	Properties {
		
		_RimColor ("Rim Color", Color) = (0.91, 0.91, 0.89,1)
	...
	SubShader {
        ...
        Pass {
            ...
            v2f vert (appdata v) {
                ...
                v2f o;
                o.vertex = UnityObjectToClipPos(v.vertex);
                o.vertex.xy += extend * _OutlineWidth0 * 0.002 * o.vertex.w; // Adjusted scaling factor for visibility
        ...
        Pass {
            ...
            v2f vert (appdata v) {
                ...
                v2f o;
                o.vertex = UnityObjectToClipPos(v.vertex);
                o.vertex.xy += extend * (_OutlineWidth0 + _OutlineWidth1) * 0.002 * o.vertex.w; // Adjusted scaling factor
